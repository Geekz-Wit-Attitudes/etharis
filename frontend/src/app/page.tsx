            ...
            <section id="how-it-works" className="bg-[var(--color-neutral)] py-16 border-y-4 border-[var(--color-primary)]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <AlternatingInfoBlock
                        ...
                        imagePath="/automate.png"
                        reverse={false}
                    />

                    <AlternatingInfoBlock
                        title="4. FAIR DISPUTE RESOLUTION"
                        description="In case of disagreement, the Creator is empowered with the final decision on compromise (50% partial) or rejection (100% refund to Brand, Creator keeps content license). This unique mechanism prevents Brand bullying."
