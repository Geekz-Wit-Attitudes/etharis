...
import { Handshake, User, LogOut } from 'lucide-react'
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    <Link href={dashboardPath} className="flex items-center gap-2">
                        ...
                        <div className="w-8 h-8 bg-[var(--color-primary)] border-2 border-[var(--color-secondary)] flex items-center justify-center">
                            <Handshake className="w-5 h-5 text-[var(--color-secondary)]" />
                        </div>
                    ...
                    {!isAuthenticated ? (
                        ...
                        <div className="flex items-center space-x-3 h-[2vw]">
                            {/* Tombol Profile */}
                            <button 
